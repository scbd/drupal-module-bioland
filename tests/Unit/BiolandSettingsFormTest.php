...
use Drupal\bioland\Form\BiolandGeneralSettingsForm;
...
/**
 * Unit tests for BiolandGeneralSettingsForm.
 *
 * @covers \Drupal\bioland\Form\BiolandGeneralSettingsForm
 */
class BiolandSettingsFormTest extends TestCase {
   ...
   *
   * @return \Drupal\bioland\Form\BiolandGeneralSettingsForm
   *   The form instance.
   */
  protected function createForm(): BiolandGeneralSettingsForm {
    return new BiolandGeneralSettingsForm(
   ...
   *   The form instance.
   */
  protected function createFormWithConfig(array $configData): BiolandGeneralSettingsForm {
    $form = $this->createForm();
    ...
    return new class($this->languageManager, $this->entityTypeManager, $this->translationBatchService, $this->database, $this->currentUser, $this->requestStack, $configObject) extends BiolandGeneralSettingsForm {
  ...
  public function testExtractGeneralSettingsReadsSiteName(): void {
    $mapped = BiolandGeneralSettingsForm::extractGeneralSettings(
  ...
  public function testSubmitGeneralMirrorsToSystemConfig(): void {
    ...
    $form = new class($languageManager, $this->entityTypeManager, $this->translationBatchService, $this->database, $this->currentUser, $this->requestStack, $factory) extends BiolandGeneralSettingsForm {
